    ...
    <value>
      <struct>
        ...
        public void Test1()
        {
            ...
            Assert.AreEqual(el is Matrix.Xmpp.Rpc.Rpc, true);

            var rpc = el as Matrix.Xmpp.Rpc.Rpc;

            var call = rpc.MethodCall;
            Assert.AreEqual(call != null, true);
            Assert.AreEqual(call.MethodName, "bid");
        ...
        public void Test2()
        {
            ...
            Assert.AreEqual(resp != null, true);
