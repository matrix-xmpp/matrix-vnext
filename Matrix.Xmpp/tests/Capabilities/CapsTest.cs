    ...
    <feature var='urn:xmpp:jingle:transports:ice-udp:1' />
        ...
        public void TestBuildHash()
        {
            ...
            if (el is Info)
            {
                ...
                Assert.AreEqual(hash, "q07IKJEyjvHSyhy//CH0CxmKi8w=");
            }
        }
        ...
        public void TestBuildHash2()
        {
            ...
            if (el is Info)
            {
                ...
                Assert.AreEqual("XH3meI11JZj00/DhOlop7p7jKBE=", hash);
            }
        }
        ...
        public void TestBuildHash5()
        {
            ...
            {
                string hash = Caps.BuildHash(el as Info);
                Assert.AreEqual("8ungGR8ouA8Bi9LIUp8r3+1tgbY=", hash);
        ...
        public void TestCapsInStreamFeatures()
        {
            ...
            if (el is StreamFeatures)
            {
                ...
                var caps = feat.Caps;
                Assert.AreEqual(caps.Node, "http://jabberd.org");
                Assert.AreEqual(caps.Version, "ItBTI0XLDFvVxZ72NQElAzKS9sU=");
                Assert.AreEqual(caps.Hash, "sha-1");
            }
        }
    }
}
