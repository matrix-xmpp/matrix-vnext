...
namespace Matrix.Core.Tests.Crypt
{
    ...
    public class UnitTest1
    {
        ...
        {
            Assert.AreEqual(Hash.HashAlgorithmsFromName("sha-384"), HashAlgorithms.Sha384);
            Assert.AreEqual(Hash.HashAlgorithmsFromName("SHa-384"), HashAlgorithms.Sha384);
            Assert.AreNotEqual(Hash.HashAlgorithmsFromName("sha-385"), HashAlgorithms.Sha384);
            Assert.AreEqual(Hash.HashAlgorithmsFromName("sha-222"), HashAlgorithms.Unknown);
            Assert.AreEqual(Hash.HashAlgorithmsFromName("foo"), HashAlgorithms.Unknown);
            Assert.AreEqual(Hash.HashAlgorithmsFromName(null), HashAlgorithms.Unknown);
        }
