...
<retrieve xmlns='urn:xmpp:archive' 
    ...
    start='1469-07-21T02:56:15.000Z'>
        ...
        public void ChatTest1()
        {
            ...
            Assert.Equal(true, xmpp1 is Chat);
            ...
            if (chat != null)
            {
                ...
                Assert.Equal(to.Body, "Neither, fair saint, if either thee dislike.");
                Assert.Equal(to.Seconds, 11);

                var from = chat.Element<From>();
                Assert.Equal(from.Body, "Art thou not Romeo, and a Montague?");
                Assert.Equal(from.TimeStamp.ToUniversalTime(), new DateTime(1469, 07, 21, 0, 32, 29,DateTimeKind.Utc));
            }
        }
        ...
        public void PrefTest1()
        {
            ...
            Assert.Equal(true, xmpp1 is Preferences);
